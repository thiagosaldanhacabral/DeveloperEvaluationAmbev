...
public class CreateUserHandlerTests
{
    ...
    public CreateUserHandlerTests()
    {
        ...
        _userCreateRepository = Substitute.For<IUserCreateRepository>();
        _handler = new CreateUserHandler(_userRepository, _mapper, _passwordHasher, _userCreateRepository);
    }
